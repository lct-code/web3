...
class LebaraController extends BaseController
{
    public function __construct(
        protected Request $request,
        protected Subscription $subscription,
        protected Lebara $lebara
    ) {}
    ...
    public function subscribeStart(): JsonResponse
    {
        ...
        try {
            $data = $this->lebara->subscribeStart(
                $data['price_id'],
                $data['phone'],
                $this->request->user(),
            );
    ...
    public function subscribeVerify(): JsonResponse
    {
        ...
        try {
            $data = $this->lebara->subscribeVerify(
                $data['price_id'],
                Auth::user(),
                $data['auth_code'],
            );
    ...
    public function syncSubscriptionDetails(): Response|JsonResponse
    {
        ...
        try {
            $data = $this->lebara->syncSubscriptionDetails(
                $data['price_id'],
                Auth::user(),
            );
        } catch (\Exception $e) {
