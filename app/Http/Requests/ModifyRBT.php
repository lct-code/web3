...
class ModifyRBT extends BaseFormRequest
{
    public function messages(): array
    {
        return [
            'artists.required' => [
                __('Could not automatically determine RBT artists. Select artists manually.'),
            ]
        ];
    }
    ...
    public function rules(): array
    {
        ...
        if ($this->request->get('album_id')) {
            $name[] = Rule::unique('RBT')->where(function(Builder $query) {
