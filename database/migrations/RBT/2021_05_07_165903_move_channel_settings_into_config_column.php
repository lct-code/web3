    ...
    public function up()
    {
        foreach (Channel::orderBy('id')->cursor() as $channel) {
            ...
            if ($channel->auto_update) {
                if ($channel->auto_update === 'local:r_b_t:top') {
                    $config['contentType'] = 'listAll';
                    $config['contentModel'] = r_b_t::MODEL_TYPE;
                ...
                } else if ($channel->auto_update === 'local:r_b_t:new') {
                    $config['contentType'] = 'listAll';
                    $config['contentModel'] = r_b_t::MODEL_TYPE;
                    $config['contentOrder'] = 'created_at:desc';
                    ...
                    $config['contentOrder'] = 'popularity:desc';
                } else if ($channel->auto_update === 'spotify:r_b_t:top') {
                    $config['contentType'] = 'autoUpdate';
                    $config['contentModel'] = r_b_t::MODEL_TYPE;
                    $config['contentOrder'] = 'popularity:desc';
                    $config['autoUpdateMethod'] = 'spotifyTopr_b_t';
