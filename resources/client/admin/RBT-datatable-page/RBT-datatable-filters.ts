...
export const RBTDatatableFilters: BackendFilter[] = [
  {
    key: 'image',
    label: message('Artwork'),
    description: message('Whether RBT has any artwork uploaded'),
  ...
  },
  {
    key: 'album_id',
    label: message('Album'),
    description: message('Whether RBT is part of an album'),
    defaultOperator: FilterOperator.eq,
    control: {
      type: FilterControlType.Select,
      defaultValue: '01',
  ...
  },
  {
    ...
    description: message('Number of times this RBT was played'),
  ...
  }),
  {
    ...
    description: message('Artist this RBT belongs to'),
    control: {
