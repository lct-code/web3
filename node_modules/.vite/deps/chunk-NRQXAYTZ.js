        ...
        function() {
          ...
          VirtualRenderer2.prototype.setGhostText = function(text, position) {
            ...
            if (textChunks.length > 1) {
              var divs = textChunks.slice(1).map(function(el2) {
                return "<div".concat(el2.wrapped ? ' class="ghost_text_line_wrapped"' : "", ">").concat(el2.text, "</div>");
              });
...
ace-builds/src-noconflict/ace.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-NRQXAYTZ.js.map
