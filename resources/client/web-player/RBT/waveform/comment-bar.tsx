...
import {CommentBarContext} from '@app/web-player/RBT/waveform/comment-bar-context';
...
export function CommentBar({comments, RBT}: CommentBarProps) {
  ...
  const {domProps, groupId, RBTRef, getThumbPercent} = useSlider({
    onChange: () => {
