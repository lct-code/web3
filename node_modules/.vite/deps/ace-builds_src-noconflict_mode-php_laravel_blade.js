...
var require_mode_php_laravel_blade = __commonJS({
  "node_modules/ace-builds/src-noconflict/mode-php_laravel_blade.js"(exports, module) {
    ...
    ace.define("ace/mode/php_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/doc_comment_highlight_rules", "ace/mode/text_highlight_rules", "ace/mode/html_highlight_rules"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../lib/oop");
      var lang = require2("../lib/lang");
      ...
      var PhpLangHighlightRules = function() {
        ...
        var keywords = lang.arrayToMap("abstract|and|array|as|break|callable|case|catch|class|clone|const|continue|declare|default|do|else|elseif|enddeclare|endfor|endforeach|endif|endswitch|endwhile|extends|final|finally|for|foreach|function|global|goto|if|implements|instanceof|insteadof|interface|namespace|new|or|private|protected|public|static|switch|throw|trait|try|use|var|while|xor|yield".split("|"));
      ...
      exports2.PhpHighlightRules = PhpHighlightRules;
      exports2.PhpLangHighlightRules = PhpLangHighlightRules;
    });
    ace.define("ace/mode/php_laravel_blade_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/php_highlight_rules"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../lib/oop");
      var PhpHighlightRules = require2("./php_highlight_rules").PhpHighlightRules;
      ...
      exports2.PHPLaravelBladeHighlightRules = PHPLaravelBladeHighlightRules;
    });
    ...
    ace.define("ace/mode/php_completions", ["require", "exports", "module"], function(require2, exports2, module2) {
      "use strict";
      var functionMap = {
        "abs": [
          "int abs(int number)",
      ...
      exports2.PhpCompletions = PhpCompletions;
    });
    ...
    ace.define("ace/mode/folding/php", ["require", "exports", "module", "ace/lib/oop", "ace/mode/folding/cstyle", "ace/range", "ace/token_iterator"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../../lib/oop");
    ...
    ace.define("ace/mode/php", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/php_highlight_rules", "ace/mode/php_highlight_rules", "ace/mode/matching_brace_outdent", "ace/worker/worker_client", "ace/mode/php_completions", "ace/mode/folding/php", "ace/unicode", "ace/mode/folding/mixed", "ace/mode/folding/html", "ace/mode/folding/cstyle", "ace/mode/html", "ace/mode/javascript", "ace/mode/css"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var PhpHighlightRules = require2("./php_highlight_rules").PhpHighlightRules;
      var PhpLangHighlightRules = require2("./php_highlight_rules").PhpLangHighlightRules;
      var MatchingBraceOutdent = require2("./matching_brace_outdent").MatchingBraceOutdent;
      var WorkerClient = require2("../worker/worker_client").WorkerClient;
      var PhpCompletions = require2("./php_completions").PhpCompletions;
      var PhpFoldMode = require2("./folding/php").FoldMode;
      var unicode = require2("../unicode");
      var MixedFoldMode = require2("./folding/mixed").FoldMode;
      var HtmlFoldMode = require2("./folding/html").FoldMode;
      var CstyleFoldMode = require2("./folding/cstyle").FoldMode;
      var HtmlMode = require2("./html").Mode;
      var JavaScriptMode = require2("./javascript").Mode;
      var CssMode = require2("./css").Mode;
    ...
    ace.define("ace/mode/php_laravel_blade", ["require", "exports", "module", "ace/lib/oop", "ace/mode/php_laravel_blade_highlight_rules", "ace/mode/php", "ace/mode/javascript", "ace/mode/css", "ace/mode/html"], function(require2, exports2, module2) {
      "use strict";
      var oop = require2("../lib/oop");
      var PHPLaravelBladeHighlightRules = require2("./php_laravel_blade_highlight_rules").PHPLaravelBladeHighlightRules;
      var PHPMode = require2("./php").Mode;
      var JavaScriptMode = require2("./javascript").Mode;
      var CssMode = require2("./css").Mode;
      var HtmlMode = require2("./html").Mode;
      var Mode = function() {
...
export default require_mode_php_laravel_blade();
//# sourceMappingURL=ace-builds_src-noconflict_mode-php_laravel_blade.js.map
