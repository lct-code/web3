...
import {RBTUploadStatusText} from '@app/admin/RBT-datatable-page/RBT-form/RBT-upload-status-text';

export type RBTUploadStatus = FileUpload['status'] | 'processing' | undefined;
...
export function RBTUploadProgress({
  fileUpload,
  status,
  onAbort,
  size = 'md',
  ...
  return (
    <div className={className}>
      <div className="flex items-center gap-24 justify-between">
        <RBTUploadStatusText fileUpload={fileUpload} status={status} />
        <UploadStatusButton
          fileUpload={fileUpload}
          status={status}
          onAbort={onAbort}
